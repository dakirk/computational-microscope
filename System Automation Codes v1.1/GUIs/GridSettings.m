...
switch currVal
    case 'Square'
        illum.grid = 'square' %If set to square, update illum structure to reflect that
    case 'Square NA'
        illum.grid = 'squareNA' %If set to square NA, update illum structure to reflect that
end
...
global illum
set(hObject, 'String', illum.numImg) %Sets contents of textbox to reflect default number of pictures, 169
...
illum.fpath = get(hObject,'String') %Saves input as string
...
global illum
set(hObject, 'String', illum.fpath) %Sets textbox to initially show the default file path for grid files


% --- Button to open file selection GUI and select a new path for the grid
% files
...
global illum
directory = uigetdir('D:\David\SP-IRIS Project\'); %Allows user to select a new path
if directory ~= 0 %If the user selects something (and therefore uigetdir doesn't return zero), set their input as the new file path
    illum.fpath = directory
end

set(handles.edit10, 'String', illum.fpath) %Update the text box to display new path
...
global illum
set(hObject, 'String', illum.mainPath) %Sets textbox to initially show the default file path for saving images


% --- Button for changing main directory
...
set(handles.edit11, 'String', illum.mainPath) %Update the text box to display new path
