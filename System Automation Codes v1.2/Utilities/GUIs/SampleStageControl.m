...
%remotely, the user does not have to worry about producing air currents
%that could misallign the system. The user may also use this GUI to pan
%limitedly around the sample. Additionally, this program may be used to
%confirm that the main camera is working properly.
